        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Fornecedor>(entity =>
            {
                ...
                entity.HasIndex(e => e.Cnpj)
                    .HasName("UQ__Forneced__A299CC922564E8AC")
                    .IsUnique();
                ...
                entity.HasOne(d => d.IdUsuarioNavigation)
                    ...
                    .HasConstraintName("FK__Fornecedo__IdUsu__4D94879B");
            });
            ...
            modelBuilder.Entity<Pecas>(entity =>
            {
                ...
                entity.HasIndex(e => e.Codigo)
                    .HasName("UQ__Pecas__06370DAC9CDD2CE9")
                    .IsUnique();
                ...
                entity.HasOne(d => d.IdFornecedorNavigation)
                    ...
                    .HasConstraintName("FK__Pecas__IdFornece__5165187F");
            });
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email)
                    .HasName("UQ__Usuario__A9D105347A38E764")
                    .IsUnique();
